...
from src.util.convert_json_to_dictsAndEmbeddings import (
    convert_json_to_dictsAndEmbeddings,
)
...
dicts = convert_json_to_dictsAndEmbeddings(
    dir_path="./data/v12", retriever=retriever, split_paragraphs=False
)
# import pickle
