...
def convert_json_to_dicts(
    dir_path: str,
    retriever: Union[EmbeddingRetriever, DensePassageRetriever, ElasticsearchRetriever],
...
def convert_squad_to_dicts(
    ...
    for document in list_articles:
        ...
        for paragraph in document["paragraphs"]:
            ...
            text_reader = (
                paragraph["text_reader"] if "text_reader" in paragraph else text
            )
            if clean_func:
                text = clean_func(text)
