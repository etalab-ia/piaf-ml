...
def add_eval_data_from_file(filename: str, retriever_emb:BaseRetriever, max_docs: Union[int, bool]=None) -> Tuple[List[Document], List[Label]]:
    """
    ...
    with open(filename, "r") as file:
        ...
        for document in data["data"]:
            ...
            for paragraph in document["paragraphs"]:
                ...
                # Create Document
                cur_doc = Document(text=paragraph["context"], embedding=embedding, meta=cur_meta)
