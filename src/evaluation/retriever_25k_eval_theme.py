...
def get_filters_list(test_corpus_path):
...
def load_25k_test_set(test_corpus_path: str, filter_name, filter_value):
    ...
    :return: Dict with the questions as key and the referenced fiches' URLs as values, List of Themes, List of Dossiers
    """
