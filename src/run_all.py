...
from src.data.knowledge_base import arborescence, prepare_spf_kbase
...
download_and_save(
    "https://lecomarquage.service-public.fr/vdd/3.0/part/zip/vosdroits-latest.zip",
    path_to_xml,
)
...
prepare_spf_kbase.main(
    path_to_xml,
    path_to_json,
    path_to_arbo_folder / "arborescence.json",
    n_jobs=1,
    as_json=1,
    as_one=0,
)
